...
import ClientesPage from './settings/Clientes/ClientesPage';
import ClientePage from './settings/Clientes/CleintePage';

import RevendasPage from './settings/Revendas/RevendasPage';
import RevendaPage from './settings/Revendas/RevendaPage';

import UsersPage from './settings/Users/UsersPage';
import UserPage from './settings/Users/UserPage';

import Apiwhats from './Apiwhats/WhatsApp';
        ...
        <Routes>
            ...
            <Route path="/" element={<App />}>
                ...
                <Route path="settings">
                    ...
                    <Route path="apiwhats" element={<Apiwhats />} />

                    <Route path="clientes" element={<ClientesPage />} />
                    <Route path="cliente/:id/connections" element={<UserConnectionsPage />} />
                    <Route path="cliente/:id" element={<ClientePage />} />
                    <Route path="cliente" element={<ClientePage />} />

                    <Route path="revendas" element={<RevendasPage />} />
                    <Route path="revenda/:id/connections" element={<UserConnectionsPage />} />
                    <Route path="revenda/:id" element={<RevendaPage />} />
